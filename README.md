...
<svg xmlns="http://www.w3.org/2000/svg"
     ...
     width="800mm" height="600mm"
     viewBox="0 0 800 600">
  <title>Basic SVG Elements</title>
  <desc>An SVG showing a line, a circle, and a rectangle.</desc>

  <!-- A straight line from (100,100) to (300,100) -->
  <line x1="100" y1="100" x2="300" y2="100" stroke="black" stroke-width="2" />

  <!-- A circle centered at (200, 200) with radius 50 -->
  <circle cx="200" cy="200" r="50" fill="red" />

  <!-- A rectangle at (100,300) with width 200 and height 100 -->
  <rect x="100" y="300" width="200" height="100" fill="blue" />
</svg>
...
<details>
 ...
 Rauten werden in Markdown verwendet, um Überschriften zu erstellen.
</details>
<details>
    <summary>How do you mark italic or bold font?</summary>
    <code>
  Mit einzelnen sternchern (*) formatiert man Krsiven Text und mit doppelten Sternchen oder Unterstrichen fettgedruckten text.
    </code>
</details>
<details>
    <summary>Which different ways are there to generate listings and tables?</summary>
    <code>
    für A ufzählungen benutzt man, -, *, oder + und für Tabellen benutzt man, | senkrechter strich und (-) Bindestrich.
    </code>
</details>
